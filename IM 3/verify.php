...
form .btn input[type="submit"]{
      ...
      <div class="wrapper">
         ...
         <div class="form-container">
            <div class="form-inner">
               <form action="verify_code.php" class="login" method="POST">
                  <div class="field">
                     <input type="text" id="cnf" placeholder="enter your code" name="uval" required><br> 
 ...
 $ss=$_SESSION['email1'];
 $name=$_SESSION['fname1'].$_SESSION['lname1'];
