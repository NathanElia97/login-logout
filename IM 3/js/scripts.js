    ...
    document.addEventListener("DOMContentLoaded", (event) => {
        ...
        document.getElementById("submit").addEventListener("click", (e) => {
            e.preventDefault();
            const PBFKey = "FLWPUBK_TEST-80975863cf37301f7fa94c8995153df9-X"; // paste in the public key from your dashboard here
        ...
        getpaidSetup({
            ...
            txref: txRef, // Pass your UNIQUE TRANSACTION REFERENCE HERE.
             title: "proficientworkers.com",
         description: "Payment for an deposite proficientworkers.com",
         logo: "https://www.proficientworkers.com/img/logo.png",
